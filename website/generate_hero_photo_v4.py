#!/usr/bin/env python3
"""
Generiert Hero-Bild v4 - Editorial Foto, Pferde links 60%, rechts frei
"""
...
def main():
    print("\n" + "=" * 60)
    print("🐴 PFERDESICHT - Hero v4: Editorial Foto")
    print("=" * 60)
...
RESOLUTION: 1920x1080"""
    ...
    success = generate_image(
        prompt=prompt,
        aspect_ratio="16:9",
        output_path=output_dir / "hero-herde-photo-v4.png",
    )

    print("\n" + "=" * 60)
    if success:
        print("✅ Hero v4 wurde generiert!")
    else:

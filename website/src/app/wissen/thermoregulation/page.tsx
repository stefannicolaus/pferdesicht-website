...
export default function ThermoregulationPage() {
    ...
    async function fetchPosts() {
      try {
        ...
        if (response.ok) {
          ...
          // Filter by thermoregulation category or related tags
          const filtered = data.filter(
            (post: PostMeta) =>
              post.frontmatter.category.toLowerCase() === "thermoregulation" ||
              post.frontmatter.category.toLowerCase() === "gesundheit" ||
              post.frontmatter.tags?.some((tag: string) =>
                ["thermoregulation", "eindecken", "temperatur", "fellwechsel", "schwitzen"].includes(
                  tag.toLowerCase()
                )
              )
          );
      ...
      <section className="bg-bg-light py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <nav className="flex justify-center items-center gap-2 text-sm text-loam-500 mb-6">
            ...
            <span className="text-loam-900 font-medium">Thermoregulation</span>
          </nav>

          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-loam-900 leading-tight mb-6">
            Thermoregulation &{" "}
            <span className="italic">Eindecken</span>
          </h1>
          <p className="text-xl text-loam-600 leading-relaxed max-w-2xl mx-auto">
            Verstehe, wie dein Pferd seine Körpertemperatur reguliert – und wann eine Decke wirklich sinnvoll ist.
            Faktenbasiert statt Bauchgefühl.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Temperaturregulation</h3>
                <p className="text-sm text-loam-600">Wie Pferde Wärme produzieren und abgeben</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Eindecken</h3>
                <p className="text-sm text-loam-600">Wann sinnvoll, wann kontraproduktiv?</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Winter & Kälte</h3>
                <p className="text-sm text-loam-600">Thermoneutrale Zone und Kälteschutz</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Fellwechsel</h3>
                <p className="text-sm text-loam-600">Übergangsphasen richtig begleiten</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="text-center md:text-left">
              <h2 className="font-serif text-2xl sm:text-3xl text-loam-900 mb-4">
                Meine Erfahrung mit Thermoregulation
              </h2>
              <div className="space-y-4 text-loam-600 leading-relaxed">
                <p>
                  In 20 Jahren Offenstallhaltung habe ich gelernt: Pferde frieren viel seltener,
                  als wir denken. Ihr Fell ist ein Wunderwerk der Evolution – wenn wir es lassen.
                </p>
                <p className="font-medium text-loam-900">
                  Die Frage ist nicht „Braucht mein Pferd eine Decke?" – sondern „Warum glaube ich das?"
                </p>
              </div>
            </div>
          </div>

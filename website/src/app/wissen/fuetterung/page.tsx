...
export default function FuetterungPage() {
    ...
    async function fetchPosts() {
      try {
        ...
        if (response.ok) {
          ...
          // Filter by fuetterung category or related tags
          const filtered = data.filter(
            (post: PostMeta) =>
              post.frontmatter.category.toLowerCase() === "fuetterung" ||
              post.frontmatter.category.toLowerCase() === "fütterung" ||
              post.frontmatter.category.toLowerCase() === "gesundheit" ||
              post.frontmatter.tags?.some((tag: string) =>
                ["fütterung", "fuetterung", "heu", "kraftfutter", "mineralfutter", "fruktan", "anweiden", "weide"].includes(
                  tag.toLowerCase()
                )
              )
          );
      ...
      <section className="bg-bg-light py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <nav className="flex justify-center items-center gap-2 text-sm text-loam-500 mb-6">
            ...
            <span className="text-loam-900 font-medium">Fütterung</span>
          </nav>

          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-loam-900 leading-tight mb-6">
            Fütterung &{" "}
            <span className="italic">Verdauung</span>
          </h1>
          <p className="text-xl text-loam-600 leading-relaxed max-w-2xl mx-auto">
            Was dein Pferd wirklich braucht – und was nicht. Rationsgestaltung, Weidemanagement
            und die Wahrheit über Zusatzfutter.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Heu & Raufutter</h3>
                <p className="text-sm text-loam-600">Die Basis jeder gesunden Fütterung</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Weide & Anweiden</h3>
                <p className="text-sm text-loam-600">Fruktan, Hufrehe und sichere Strategien</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Rationsberechnung</h3>
                <p className="text-sm text-loam-600">Bedarf ermitteln und decken</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Zusatzfutter</h3>
                <p className="text-sm text-loam-600">Was wirklich sinnvoll ist</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="text-center md:text-left">
              <h2 className="font-serif text-2xl sm:text-3xl text-loam-900 mb-4">
                15 Jahre Fütterungsberatung
              </h2>
              <div className="space-y-4 text-loam-600 leading-relaxed">
                <p>
                  Bei Hempura habe ich tausende Gespräche über Pferdefütterung geführt.
                  Die häufigste Erkenntnis: Weniger ist oft mehr – und teuer ist nicht gleich besser.
                </p>
                <p className="font-medium text-loam-900">
                  Das beste Futter nützt nichts, wenn die Basis nicht stimmt. Heu first, alles andere second.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-sage-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-white mb-6">
            Weißt du, was dein Pferd jetzt braucht?
          </h2>

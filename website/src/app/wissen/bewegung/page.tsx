    ...
    async function fetchPosts() {
      try {
        ...
        if (response.ok) {
          ...
          // Filter by bewegung/training category or related tags
          const filtered = data.filter(
            (post: PostMeta) =>
              post.frontmatter.category.toLowerCase() === "bewegung" ||
              post.frontmatter.category.toLowerCase() === "training" ||
              post.frontmatter.tags?.some((tag: string) =>
                ["bewegung", "training", "reiten", "bodenarbeit", "longieren", "freiarbeit", "muskelaufbau"].includes(
                  tag.toLowerCase()
                )
              )
          );
      ...
      <section className="bg-bg-light py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <nav className="flex justify-center items-center gap-2 text-sm text-loam-500 mb-6">
            ...
            <span className="text-loam-900 font-medium">Bewegung</span>
          </nav>
          ...
          <p className="text-xl text-loam-600 leading-relaxed max-w-2xl mx-auto">
            Von der Grundlagenarbeit bis zur Freiheitsdressur. Wie du dein Pferd gesund bewegst –
            im Einklang mit seiner Natur.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Freie Bewegung</h3>
                <p className="text-sm text-loam-600">Warum Weidegang allein nicht reicht</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Bodenarbeit</h3>
                <p className="text-sm text-loam-600">Kommunikation und Gymnastizierung</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Reiten</h3>
                <p className="text-sm text-loam-600">Gesunderhaltendes Training</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl bg-sage-50">
              <div className="w-10 h-10 bg-sage-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-medium text-loam-900 mb-1">Freiarbeit</h3>
                <p className="text-sm text-loam-600">Vertrauen ohne Seil</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="text-center md:text-left">
              <h2 className="font-serif text-2xl sm:text-3xl text-loam-900 mb-4">
                5 Jahre bei den besten Trainern
              </h2>
              <div className="space-y-4 text-loam-600 leading-relaxed">
                <p>
                  Durch Kooperationen durfte ich den bekanntesten Trainern der Freiarbeit
                  über die Schulter schauen. Was ich gelernt habe: Echte Partnerschaft
                  braucht kein Seil.
                </p>
                <p className="font-medium text-loam-900">
                  Ein Pferd, das bei dir bleibt, weil es will – nicht weil es muss.
                  Das ist das Ziel.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-sage-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-white mb-6">
            Ist dein Pferd fit für die Saison?
          </h2>
          <p className="text-white/90 text-lg mb-10 max-w-2xl mx-auto">
            Der Frühlings-Check gibt dir einen Überblick über alle wichtigen Bereiche –
            von Fütterung bis Bewegung.
          </p>
          <Link

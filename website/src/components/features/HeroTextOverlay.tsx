    ...
    <div className="absolute inset-0 z-10">
      ...
      <div className="relative h-full flex flex-col justify-center w-full md:w-[65%] lg:w-[62%] xl:w-[58%] p-5 md:p-6 lg:p-8 xl:p-10">
        ...
        <div className="mb-10 lg:mb-14">
          {/* Zeile 1: Cream - OHNE Schatten, rein und klar */}
          <h1 className="font-serif text-[1.75rem] sm:text-[2.25rem] md:text-[2.75rem] lg:text-[3.25rem] xl:text-[3.5rem] text-cream leading-[1.12] max-w-none">
            Jeder sagt mir was anderes.
          </h1>
          {/* Zeile 2+: Gold Italic, DEUTLICH GRÖSSER - ohne Schatten */}
        ...
        <div className="border-l-[3px] border-gold/60 pl-5 max-w-lg lg:max-w-xl">
          {/* Desktop version */}
          <p className="hidden sm:block font-sans text-sm md:text-base lg:text-lg text-cream/95 leading-relaxed">
          ...
          <p className="sm:hidden font-sans text-sm text-cream/95 leading-relaxed">

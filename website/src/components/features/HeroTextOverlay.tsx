...
export function HeroTextOverlay() {
  return (
    <div className="absolute inset-0 z-10">
      ...
      <div
        className="absolute top-6 md:top-[3%] left-0 w-full lg:w-[90%] px-5 pt-8 md:pt-0 lg:pr-10 lg:pt-10"
        style={{ paddingLeft: '100px', maxWidth: 'none' }}
      >
        ...
        <h1
          className="font-serif font-medium text-white leading-[1.1] tracking-tight mb-2 [text-shadow:_0_2px_4px_rgba(0,0,0,0.9),_0_4px_20px_rgba(0,0,0,0.8)] md:[text-shadow:_0_4px_30px_rgba(0,0,0,0.7)]"
        ...
        <p
          className="font-serif italic font-normal text-gold leading-[1.15] mb-6 lg:mb-8 [text-shadow:_0_2px_4px_rgba(0,0,0,0.9),_0_4px_20px_rgba(0,0,0,0.8)] md:[text-shadow:_0_4px_30px_rgba(0,0,0,0.8)]"
          style={{ fontSize: 'clamp(32px, 5vw, 60px)' }}
        >
          Und ich weiß schon lange nicht mehr, was ich glauben soll.
        </p>

        {/* Body Text mit Border */}
        <div className="border-l-2 border-gold/50 pl-4 md:pl-6 mb-8 md:mb-0">

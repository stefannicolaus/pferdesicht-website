  ...
  return (
    <div className="absolute inset-0 z-10">
      ...
      <div className="absolute top-6 lg:top-8 left-0 w-full lg:w-[90%] p-6 lg:p-10 xl:p-12">
        ...
        {/* Headline Cream */}
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-[4rem] font-normal text-white leading-[1.08] tracking-tight mb-2 lg:mb-0 max-w-none [text-shadow:_0_4px_30px_rgba(0,0,0,0.7)]">
          Jeder im Stall sagt mir was anderes.
        </h1>

        {/* Headline Gold */}
        <p className="font-serif italic text-2xl sm:text-[2rem] md:text-[2.75rem] lg:text-[3.75rem] xl:text-[4.25rem] font-normal text-gold leading-[1.08] mb-6 lg:mb-12 max-w-none [text-shadow:_0_4px_30px_rgba(0,0,0,0.8)]">

  ...
  return (
    <aside className="bg-sage rounded-lg overflow-hidden my-12">
      ...
      <div className="p-8 md:p-10 text-center">
        ...
        <a href="/quiz" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gold hover:bg-gold/90 text-white font-semibold uppercase tracking-wider text-sm rounded transition-colors w-full md:w-auto">
